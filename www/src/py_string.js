...
$StringDict.__mod__ = function(p, k){
    var self=p[0], args=p[1]
...
$StringDict.join = function(p, k){
    var $=$B.argsfast('join',2,{self:null,iterable:null},
        ['self', 'iterable'], p, k, {}, null, null)
